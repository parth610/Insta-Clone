...
Revision ID: a130e598fa21
Revises: 
Create Date: 2022-05-03 16:06:58.921259
...
def upgrade():
    ...
    sa.Column('github', sa.String(length=5000), nullable=True),
    sa.Column('linkedin', sa.String(length=5000), nullable=True),
